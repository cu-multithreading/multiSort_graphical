...
void multiSort_GraphicalApp::draw()
{
	...
	draw::drawStringRight("Min: " + conv::toString(dataStats::min), var::coord2(100, 8), false, FONT_SIZE, var::color_RGB::GREEN());
	draw::drawStringRight("Cntr:" + conv::toString((dataStats::max - dataStats::min) / 2), var::coord2(100, 6), false, FONT_SIZE, var::color_RGB::GREEN());
	draw::drawStringRight("Max: " + conv::toString(dataStats::max), var::coord2(100, 4), false, FONT_SIZE, var::color_RGB::GREEN());
